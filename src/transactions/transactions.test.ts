...
describe("Transactions Functions", () => {
  ...
  describe("getAccountBalance", () => {
    ...
    it("should throw an error if the account does not exist", async () => {
      ...
      await expect(getAccountBalance(accountIban)).rejects.toThrow("Account not found")
    })
    ...
    it("should throw an error if an unexpected error occurs", async () => {
      ...
      await expect(getAccountBalance(accountIban)).rejects.toThrow("Failed to get account balance: Boom")
    })
  })
  ...
  describe("creditTransaction", () => {
    ...
    it("should throw an error if the account does not exist", async () => {
      ...
      await expect(creditTransaction(transactionData)).rejects.toThrow("Account does not exist")
    })
  })
  ...
  describe("debitTransaction", () => {
    ...
    it("should throw an error if the account does not exist", async () => {
      ...
      await expect(debitTransaction(transactionData)).rejects.toThrow("Account does not exist")
    })
  })
  ...
  describe("transferTransaction", () => {
    ...
    it("should throw an error if the emitter account does not exist", async () => {
      ...
      await expect(transferTransaction(transactionData)).rejects.toThrow("Emitter account does not exist")
    })
    ...
    it("should throw an error if the receiver account does not exist", async () => {
      ...
      await expect(transferTransaction(transactionData)).rejects.toThrow("Receiver account does not exist")
    })
    ...
    it("should throw an error if the emitter account has insufficient funds", async () => {
      ...
      await expect(transferTransaction(transactionData)).rejects.toThrow("Emitter account has insufficient funds")
    })
  })
})
